...
class Zone32V(unittest.TestCase):
    ...
    def test_inside(self):
        ...
        self.assert_zone_equal(UTM.from_latlon(
            np.array(63.999999), np.array(11.999999)), 32, 'V')

    def test_left_of(self):
        self.assert_zone_equal(UTM.from_latlon(
            np.array(55.999999), np.array(2.999999)), 31, 'U')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(56), np.array(2.999999)), 31, 'V')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(60), np.array(2.999999)), 31, 'V')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(63.999999), np.array(2.999999)), 31, 'V')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(64), np.array(2.999999)), 31, 'W')

    def test_right_of(self):
        self.assert_zone_equal(UTM.from_latlon(
            np.array(55.999999), np.array(12)), 33, 'U')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(56), np.array(12)), 33, 'V')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(60), np.array(12)), 33, 'V')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(63.999999), np.array(12)), 33, 'V')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(64), np.array(12)), 33, 'W')

    def test_below(self):
        self.assert_zone_equal(UTM.from_latlon(
            np.array(55.999999), np.array(3)), 31, 'U')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(55.999999), np.array(6)), 32, 'U')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(55.999999), np.array(9)), 32, 'U')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(55.999999), np.array(11.999999)), 32, 'U')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(55.999999), np.array(12)), 33, 'U')

    def test_above(self):
        self.assert_zone_equal(UTM.from_latlon(
            np.array(64), np.array(3)), 31, 'W')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(64), np.array(6)), 32, 'W')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(64), np.array(9)), 32, 'W')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(64), np.array(11.999999)), 32, 'W')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(64), np.array(12)), 33, 'W')
...
class TestRightBoundaries(unittest.TestCase):
    ...
    def test_limits(self):
        self.assert_zone_equal(UTM.from_latlon(np.array(40), np.array(0)), 31)
        self.assert_zone_equal(UTM.from_latlon(
            np.array(40), np.array(5.999999)), 31)
        self.assert_zone_equal(UTM.from_latlon(np.array(40), np.array(6)), 32)

        self.assert_zone_equal(UTM.from_latlon(np.array(72), np.array(0)), 31)
        self.assert_zone_equal(UTM.from_latlon(
            np.array(72), np.array(5.999999)), 31)
        self.assert_zone_equal(UTM.from_latlon(np.array(72), np.array(6)), 31)
        self.assert_zone_equal(UTM.from_latlon(
            np.array(72), np.array(8.999999)), 31)
        self.assert_zone_equal(UTM.from_latlon(np.array(72), np.array(9)), 33)
...
class TestForcingZones(unittest.TestCase):
    ...
    def test_force_zone(self):
        ...
        # NYC should be zone 18T
        self.assert_zone_equal(UTM.from_latlon(
            np.array(40.71435), np.array(-74.00597), 19, 'T'), 19, 'T')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(40.71435), np.array(-74.00597), 17, 'T'), 17, 'T')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(40.71435), np.array(-74.00597), 18, 'u'), 18, 'U')
        self.assert_zone_equal(UTM.from_latlon(
            np.array(40.71435), np.array(-74.00597), 18, 'S'), 18, 'S')


class TestForcingAntiMeridian(unittest.TestCase):
    def assert_equal_lon(self, result, expected_lon):
        _, lon = UTM.to_latlon(np.array(result[0]), np.array(
            result[1]), result[2], result[3], strict=False)
    ...
    def test_force_east(self):
        ...
        self.assert_equal_lon(
            UTM.from_latlon(np.array(0), np.array(179.9), 1, 'N'), 179.9)

    def test_force_west(self):
        # Force point just east of anti-meridian to west zone 60

        self.assert_equal_lon(
            UTM.from_latlon(np.array(0), np.array(-179.9), 60, 'N'), -179.9)
